...
contract InsurancePlatform {
    ...
    function fileClaim() external onlyPolicyHolder hasNotClaimed {
        require(block.timestamp > policyHolders[msg.sender], "Policy has not expired");

        hasClaimed[msg.sender] = true;

        emit ClaimFiled(msg.sender, coverageAmount);
    }
}
